/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 650cde41468f05bc85fb71b9a537e534)
// Runtime types generated with workerd@1.20260708.1 2026-07-13 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	FIPE_CHECKPOINT: KVNamespace;
	bucket: R2Bucket;
	STREAM: import("cloudflare:pipelines").Pipeline<Cloudflare.FipePipelineStreamRecord>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
	}
	type FipePipelineStreamRecord = { Valor?: string; Marca?: string; Modelo?: string; AnoModelo?: number; Combustivel?: string; CodigoFipe?: string; MesReferencia?: string; Autenticacao?: string; TipoVeiculo?: number; SiglaCombustivel?: string; DataConsulta?: string; Brand?: string; BrandId?: string; Model?: string; ModelId?: number; Version?: string; VersionId?: string; Month?: string; MonthId?: string };
