...
async function doPercentage(variationId) {
  ...
  percentageModel.value = await API.percentageValue(variacao_id, "yearly")
  percentageMonth.value = await API.percentageValue(variacao_id, "monthly")
}
